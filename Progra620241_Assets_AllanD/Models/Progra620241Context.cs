...
namespace Progra620241_Assets_AllanD.Models;
...
public partial class Progra620241Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AssetId).HasName("PK__Asset__434923723AD72B0C");
        ...
        {
            entity.HasKey(e => e.AssetCategoryId).HasName("PK__AssetCat__C381F49DFD5AC592");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BCD46F0CA81");
        ...
        {
            entity.HasKey(e => e.DepreciationId).HasName("PK__Deprecia__DEEBFE2932251DD0");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC6DF1DCE7");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A550176DA59");
